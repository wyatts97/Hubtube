...
<div
    class="fi-wi-stats-overview-stat fi-widget rounded-xl bg-white dark:bg-gray-900 shadow-sm border border-gray-200 dark:border-gray-800 overflow-hidden"
>
    <div class="p-4">
    ...
    @if (!empty($chart) && max($chart) > 0)
        ...
        @endphp
        <div class="px-4 pb-3">
            <svg class="w-full h-7" viewBox="0 0 {{ $width }} {{ $height }}" preserveAspectRatio="none">
                <polyline
                    points="{{ $polyline }}"
                    fill="none"
