...
<div class="fi-widget rounded-xl bg-gray-900 shadow-sm border border-gray-800 overflow-hidden h-full flex flex-col">
    <div class="p-4 flex-1">
        ...
        <div class="flex items-center justify-between mb-2">
            <div class="flex items-center gap-1.5">
                ...
                <span class="text-sm font-medium text-gray-400">Visitors</span>
            </div>
                ...
                @foreach (['1d' => '1D', '7d' => '7D', '14d' => '14D'] as $key => $label)
                    <button
                        ...
                        @class([
                            ...
                            'bg-gray-800 text-gray-400 border-gray-700 hover:bg-gray-700' => $range !== $key,
                            'rounded-l-md' => $key === '1d',
