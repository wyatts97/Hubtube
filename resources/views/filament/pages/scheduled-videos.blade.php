<x-filament-panels::page>
    <div class="space-y-6">
        <x-filament::section heading="Scheduled Draft Queue" icon="phosphor-list-numbers" description="Drag rows to reorder. Publish times update to match.">
            {{ $this->table }}
        </x-filament::section>

        @php
            $recentlyPublished = \App\Models\Video::with('user')
