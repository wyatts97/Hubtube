            ...
            <div class="fi-section-content px-6 pb-6">
                ...
                <div class="mt-4 flex items-center gap-3">
                    <button
                        ...
                        class="fi-btn fi-btn-size-md relative grid-flow-col items-center justify-center font-semibold outline-none transition duration-75 focus-visible:ring-2 rounded-lg fi-btn-color-primary fi-color-custom bg-custom-600 text-white shadow-sm hover:bg-custom-500 dark:bg-custom-500 dark:hover:bg-custom-400 focus-visible:ring-custom-500/50 dark:focus-visible:ring-custom-400/50 fi-ac-action fi-ac-btn-action gap-1.5 px-3 py-2 text-sm inline-grid"
