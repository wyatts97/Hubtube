...
<template>
    ...
    <AppLayout>
        <div class="mb-6">
            ...
            <p class="mt-1" style="color: var(--color-text-secondary);">Hand-picked featured content</p>
        </div>
        ...
        <div v-else class="text-center py-16">
            ...
            <p class="text-lg" style="color: var(--color-text-secondary);">No featured videos yet</p>
