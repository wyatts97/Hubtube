                ...
                <TabsContent value="profile" class="space-y-6">
                    ...
                    <form @submit.prevent="updateProfile" class="space-y-4">
                        ...
                        <div v-if="emailChanged">
                            <label for="profile-current-password" class="block text-sm font-medium mb-1 text-text-secondary">{{ t('settings.current_password') }}</label>
                            <input id="profile-current-password" v-model="profileForm.current_password" type="password" autocomplete="current-password" class="input" />
                            <p v-if="profileForm.errors.current_password" class="text-red-500 text-sm mt-1">
