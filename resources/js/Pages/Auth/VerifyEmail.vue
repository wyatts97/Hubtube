    ...
    <div class="min-h-screen flex items-center justify-center px-4 bg-bg-primary">
        <div class="w-full max-w-md">
            <div class="text-center mb-8">
                <div class="w-16 h-16 rounded-full flex items-center justify-center mx-auto bg-accent" style="opacity: 0.9;">
                    <Mail class="w-8 h-8 text-white" />
                </div>
                <h1 class="text-2xl font-bold mt-4 text-text-primary">{{ t('auth.verify_email') || 'Verify Your Email' }}</h1>
            ...
            <div class="card p-6 text-center">
                ...
                <div class="mt-4">
                    <form @submit.prevent="$inertia.post('/logout')">
                        <button type="submit" class="text-sm hover:opacity-80 text-text-secondary">
