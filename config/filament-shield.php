...
return [
    ...
    */
    ...
    'shield_resource' => [
        ...
        'cluster' => null,
        'tabs' => [
            // Pages and widgets are gated by the super-admin tier, not by
            // permissions, so listing them here would only mislead.
            'pages' => false,
            'widgets' => false,
            'resources' => true,
    ...
    */
    ...
    'custom_permissions' => [
        'bypass_video_approval',
        'bypass_upload_limits',
    ],
