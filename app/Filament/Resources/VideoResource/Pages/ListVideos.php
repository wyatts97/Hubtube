...
class ListVideos extends ListRecords
{
    ...
    public function getTabs(): array
    {
        return [
            ...
            ->badge(fn () => Video::where('is_approved', false)->where('status', 'processed')->whereNull('scheduled_at')->whereNull('queue_order')->count())
            ->badgeColor('warning'),
            ...
            ->badge(fn () => Video::where('is_approved', false)->where(fn($q) => $q->whereNotNull('scheduled_at')->orWhereNotNull('queue_order'))->count())
            ->badgeColor('info'),
